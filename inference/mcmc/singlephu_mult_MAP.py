...
x_MLE_low = [0,     -0.2,    0,     -0.2,    0,     0,      -0.2,      0,         0,                   0]
x_MLE_up = [0.2,    0,      0.2,    0,       0.2,   0.2,   0.0,       0.2 ,  0.001 * 2794356.0,   0.001 * 2794356.0]





#### For Synethtic case -2
# bval = 0.2

# x_MLE_low = [ 0.15090866  - bval, -0.1000742 - bval,  0.06064663  - bval, -0.0891702 - bval, 0.04714598  - bval,  0.04359538 - bval, 0.01-bval,  0, 0]

# x_MLE_up = [ 0.15090866  + bval, -0.1000742 + bval,  0.06064663  + bval, -0.0891702 + bval, 0.04714598  + bval,  0.04359538 + bval, 0.01+ bval, 0.001 * 2794356.0, 0.001 * 2794356.0]
...
mylabel = [r'$a_{0}$',r'$a_{1}$', r'$a_{2}$',r'$a_{3}$', r'$a_{4}$', r'$a_{5}$', r'$a_{6}$', r'$a_{7}$', r'$a_{8}$', r'$a_{9}$']
...
figpath = '/Users/sudhipv/documents/sum_of_sigmoid/figs/mcmc/real_MAP'
...
if __name__ == '__main__': #the main part of the program.
    ...
    Xsmp,Chain,_,comm = run_tmcmc(Nsmp,all_params,logposterior,parallel_processing,f'{datapath}/stat-file-tmcmc_real_MAP.txt')
...
##### IF YOU WANT TO LOAD PREVIOUSLY GENERATED SAMPLES 
    ...
    Xsmp = Xsmp.T
    np.savetxt(f'{datapath}/muVec_real_MAP.dat',Xsmp)
    np.savetxt(f'{datapath}/muVec_long_real_MAP.dat',Chain)
