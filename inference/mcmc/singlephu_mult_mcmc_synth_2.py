...
x_MLE_low = [0,     -0.2,    0,     -0.2,    0,     0,       0,   0,               0,                        0]
x_MLE_up = [0.2,    0,      0.2,    0,       0.2,   0.2,   0.2,  0.2,    0.001 * 2794356.0,   0.001 * 2794356.0]
...
#### USE THE TIME FOR EACH SIGMOID ACCORDING TO YOUR PHU #########
    ...
    beta_i[:,0] = param[0]  + param[1]/(1 + np.exp((t1-tmoh))) \
        ...
        + param[4]/(1 + np.exp((t4-tmoh)))  + param[5]/(1 + np.exp((t5-tmoh)))  + param[6]/(1 + np.exp((t6-tmoh)))  + param[7]/(1 + np.exp((t7-tmoh)))
